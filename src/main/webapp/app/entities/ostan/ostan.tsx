...
export const Ostan = (props: IOstanProps) => {
  ...
  const { ostanList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="ostan-heading">
        <span>استان ها</span>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${ostan.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      <div className={ostanList && ostanList.length > 0 ? '' : 'd-none'}>
