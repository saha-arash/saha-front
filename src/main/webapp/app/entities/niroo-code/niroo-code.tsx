...
export const NirooCode = (props: INirooCodeProps) => {
  ...
  const { nirooCodeList, match, loading, totalItems } = props;
  return (
    <div>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${nirooCode.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      <div className={nirooCodeList && nirooCodeList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ nirooCode }: IRootState) => ({
  ...
  totalItems: nirooCode.totalItems
});
